...
4. Click on the "Settings" button in ribbon and then on "Numbers", "Dates" or "Cells" to access the predifined styles and to add your own styles to the cycles, or to remove or modify existing ones
